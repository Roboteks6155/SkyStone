...
@Disabled
@Autonomous(name="AutoDrivePickupPlaceStone",group= "Example" )
public class AutoDrivePickupPlaceStone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        /********************************************************************
         Actions the robot must to once the program is initialized
         ********************************************************************/
        ...
        /*****************************************************************************
        Waits for the player to click start
        *****************************************************************************/
        waitForStart();
        /********************************************************************
        Steps to make the robot collect the Skystone and drop it on the foundation
         ********************************************************************/



        //Step 1: Move robot forward 7 inches towards the Skystone so that 2 stones are visible
        encoderDrive(0.7,7,7,5);


        //Step 2: Activate Vuforia to sense where the Skystone is
        /*
        ...
        final float CAMERA_LEFT_DISPLACEMENT     = 3.75f;     // eg: Camera is ON the robot's center line
