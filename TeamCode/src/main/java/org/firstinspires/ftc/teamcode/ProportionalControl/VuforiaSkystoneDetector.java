...
public class VuforiaSkystoneDetector {
    ...
    private final float bridgeRotY = 59;                                 // Units are degrees
    private final float bridgeRotZ = 180;
    ...
    public void init(HardwareMap hardwareMap) {
        ...
        final float CAMERA_VERTICAL_DISPLACEMENT = 2.5f * mmPerInch;   // eg: Camera is 8 Inches above ground
...
//                telemetry.addData("Visible Target", trackable.getName());
    ...
    public double getTranslation(int index) {
        ...
        return lastLocation.getTranslation().get(index);
    }

    public double getXTranslation() {
        return getTranslation(0) / mmPerInch;
    }

    public double getYTranslation() {
        return getTranslation(1) / mmPerInch;
    }

    public double getZTranslation() {
        return getTranslation(2) / mmPerInch;
    }
